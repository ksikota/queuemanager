...
/**
 * Created by Branden on 12/9/2015.
 */
public class DBCompletedAdapter {
    ...
    /////////////////////////////////////////////////////////////////////
    // For logging:
    private static final String TAG = "DBCompletedAdapter";
    ...
    public static final int COL_TIME_COMPLETED = 28;
    public static final int COL_CONSULTANT = 29;
    ...
    public static final String DATABASE_NAME = "completedQueryDb";
    public static final String DATABASE_TABLE = "completedQueryTable";
    ...
    private DatabaseCompletedHelper myDBHelper;
    ...
    public DBCompletedAdapter(Context ctx) {
        this.context = ctx;
        myDBHelper = new DatabaseCompletedHelper(context);
    }

    // Open the database connection.
    public DBCompletedAdapter open() {
    ...
    public long insertRow(String name, String cell, int[] check, String desc, String strTime, int consultant) {
        ...
        initialValues.put(KEY_TIME_COMPLETED, strTime);
    ...
    public Cursor getAllRows() {
        ...
        Cursor c = db.query(true, DATABASE_TABLE, ALL_KEYS,
                where, null, null, null, KEY_TIME_COMPLETED + " ASC", null);
        if (c != null) {
            c.moveToFirst();
        }
        return c;
    ...
    public boolean updateRow(long rowId, String name, String cell, int[] check, String desc, String strTime, int consultant) {
        String where = KEY_ROWID + "=" + rowId;
        ...
        newValues.put(KEY_TIME_COMPLETED, strTime);
     ...
     */
    private static class DatabaseCompletedHelper extends SQLiteOpenHelper {
        DatabaseCompletedHelper(Context context) {
